...
const HeroSection = () => (
  <section className="flex items-center justify-center h-screen bg-gradient-to-r from-yellow-100 to-blue-100">
    <div className="text-center">
      <h1 className="text-5xl font-extrabold text-gray-800 mb-4">Your Health, Our Priority</h1>
      <p className="text-lg text-gray-600 mb-6">Ah randi randi kurchondi</p>
